%% SCRIPT TO MAKE PLOTS FOR ANEMOMETER CALIBRATION AND GET CALIBRATION VALUES
...
%get processed data and prepare paths for plot output
folder_ProcessedData = '../../../../../../../../Google Drive/Data/AeolianFieldwork/Processed/'; %folder for storing data output
folder_Plots = '../PlotOutput/Calibration/'; %folder for plots
Metadata_Path = strcat(folder_ProcessedData,'Metadata_OceanoCalibration'); %get path to saving meta data
ProcessedData_Path = strcat(folder_ProcessedData,'ProcessedData_OceanoCalibration'); %get path to saving processed data
